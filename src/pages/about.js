    ...
    <div className="video">
      ...
      <div className="pres">
        ...
        <p>
          ...
          Esmod Paris de 2015 à 2018. Elle commence à faire ses preuves durant
          un stage de modéliste chez Bleu Comme Gris, marque de luxe pour enfant
          en 2016. En 2017 elle lance sa marque 12:50 . Sa marque vise un
          ...
          collections lors d’expositions temporaires. A la suite de son diplôme
          Alice effectue un stage de modélisme chez Balzac Paris et trouve
          ensuite un emploi dans le groupe GPE (Sergent Major , DPAM, Natalys).
          Durant sont temps libre elle continue tout de même de créer des
          collections.{" "}
        </p>
      </div>
    </div>
